        ...
        <div className="text-center">
          ...
          <div className="flex flex-row justify-center items-center gap-3 sm:gap-6 px-4">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="group relative w-14 h-14 sm:w-20 sm:h-20 rounded-xl sm:rounded-2xl flex items-center justify-center glass-card-premium border border-primary/25 hover:border-primary/50 transition-ultra hover-glow"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-primary/25 via-luxury/15 to-platinum/10 opacity-0 group-hover:opacity-100 transition-all duration-700 rounded-xl sm:rounded-2xl blur-xl"></div>
              <svg className="w-7 h-7 sm:w-10 sm:h-10 text-primary relative z-10 transition-transform duration-500 group-hover:scale-110" fill="currentColor" viewBox="0 0 24 24">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-diamond/25 via-platinum/15 to-luxury/10 opacity-0 group-hover:opacity-100 transition-all duration-700 rounded-xl sm:rounded-2xl blur-xl"></div>
              <Send className="w-7 h-7 sm:w-10 sm:h-10 text-diamond relative z-10 transition-transform duration-500 group-hover:scale-110" />
              {/* Removed dot pattern */}
            </a>
          </div>
        </div>
